...
plot_estimation(x, f, y, a_estimated_analytic, title="Estimating Least Squares", fig_path="estimating_least_squares.png")
a_vec_estimated_adagrad = estimate_a_constraint_GD(X, y, LrHandlerAdaGrad, r, m, n, max_iter, eps)
a_vec_estimated_decrease = estimate_a_constraint_GD(X, y, LrHandlerDecreasing, r, m, n, max_iter, eps)
